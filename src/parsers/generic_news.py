...
class GenericNewsParser(BaseParser):
    ...
    async def can_parse(self, url: str, context: Optional[Dict[str, Any]] = None) -> bool:
        ...
        news_patterns = [
            ...
            r"/\d{4}/\d{2}/", r"/blog/", r"/(news|article|story)"
        ]
    ...
    async def _extract_with_multiple_methods(self, page: Page, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if extracted:
                article_data.update({
                    ...
                    "published_at": self._parse_date(getattr(extracted, "date", None)),
            ...
            for selector in content_selectors:
                try:
                    ...
                    if content and len(content.strip()) > 100:  # Reasonable content length
                        data["content"] = content.strip()[:10000]  # Limit content length
                        break
                except:
                    continue
