...
class TestIntegration:
    ...
    def temp_seeds_file(self):
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.txt', delete=False) as f:
            ...
            f.write('{"url": "https://special.com/article", "parser": "generic-news"}\n')
            temp_path = f.name
    ...
    async def test_parser_registry_creation(self):
        ...
        try:
            from src.core.parser_registry import create_parser_registry, ParserRegistry
    ...
    async def test_url_validation(self):
        ...
        try:
            ...
            for url in valid_urls:
                ...
                assert parser is not None or parser is None  # Either found or not, but no exception
